package com.example.saiful.myintentapp;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Maskumambang Academy");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 5);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_with_object:
                Person person = new Person();
                person.setName("Maskumambang");
                person.setAge(21);
                person.setEmail("Rembangflasher@gmail.com");
                person.setCity("DKI Jakarta");
